...
<head>
  ...
  <script type="text/javascript" src="http://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=zImiqQzUz08r0O9uD6euUXyOemYhtPDe_el5epziqObO1IYR-GnjjMccIz10yegisRFQNADz6pnLw98UycWB7VFD_YmaXThUHzaOrbfMHXM" charset="UTF-8"></script><style id="cfs-style">html{display: none;}</style>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2849774023ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clinic_db&table=appoinments">`clinic_db`.`appoinments`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clinic_db&table=patients">`clinic_db`.`patients`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clinic_db&table=days_of_week">`clinic_db`.`days_of_week`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clinic_db&table=schedules">`clinic_db`.`schedules`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clinic_db&table=doctors">`clinic_db`.`doctors`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clinic_db&table=departments">`clinic_db`.`departments`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=clinic_db&table=clinics">`clinic_db`.`clinics`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=chinook_db&table=artist">`chinook_db`.`artist`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=bookstoredb&table=book">`bookstoredb`.`book`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=chinook_db&table=customer">`chinook_db`.`customer`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="3e495644754d4f5b5b2f6b6b2874792d">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="clinic_db" targettable="clinics">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `clinic_db`.`clinics` ( `clinic_id` INT NOT NULL AUTO_INCREMENT ,  `clinic_name` VARCHAR(255) NOT NULL ,  `clinic_address` VARCHAR(1000) NOT NULL ,  `clinic_details` VARCHAR(1000) NULL ,    PRIMARY KEY  (`clinic_id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="clinic_db" targettable="clinics">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `clinic_db`.`clinics` ( `clinic_id` INT NOT NULL AUTO_INCREMENT ,  `clinic_name` VARCHAR(255) NOT NULL ,  `clinic_address` VARCHAR(1000) NOT NULL ,  `clinic_details` VARCHAR(1000) NULL ,    PRIMARY KEY  (`clinic_id`),    UNIQUE  `clinic_name` (`clinic_name`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="clinic_db" targettable="departments">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `clinic_db`.`departments` ( `department_id` INT NOT NULL AUTO_INCREMENT ,  `clinic_id` INT NOT NULL ,  `department_name` VARCHAR NOT NULL ,    PRIMARY KEY  (`department_id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="clinic_db" targettable="departments">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `clinic_db`.`departments` ( `department_id` INT NOT NULL AUTO_INCREMENT ,  `clinic_id` INT NOT NULL ,  `department_name` VARCHAR(255) NOT NULL ,    PRIMARY KEY  (`department_id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="clinic_db" targettable="departments">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `departments` ADD INDEX(`clinic_id`);</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `departments`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="clinic_db" targettable="doctors">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `clinic_db`.`doctors` ( `doctor_id` INT NOT NULL AUTO_INCREMENT ,  `first_name` VARCHAR(255) NOT NULL ,  `last_name` VARCHAR(255) NOT NULL ,  `email` VARCHAR(255) NOT NULL ,  `phone` VARCHAR(10) NOT NULL ,  `department_id` INT NOT NULL ,    PRIMARY KEY  (`doctor_id`),    UNIQUE  `UK_email` (`email`),    UNIQUE  `UK_phone` (`phone`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="clinic_db" targettable="doctors">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `doctors` ADD INDEX(`department_id`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="clinic_db" targettable="doctors">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `doctors`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="clinic_db" targettable="schedules">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `clinic_db`.`schedules` ( `schedule_id` INT NOT NULL AUTO_INCREMENT ,  `is_available` BOOLEAN NOT NULL ,  `doctor_id` INT NOT NULL ,    PRIMARY KEY  (`schedule_id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="clinic_db" targettable="schedules">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `schedules` ADD INDEX(`doctor_id`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="clinic_db" targettable="schedules">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `schedules`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="clinic_db" targettable="days_of_week">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `clinic_db`.`days_of_week` ( `schedule_id` INT NOT NULL ,  `day_of_week` VARCHAR(20) NOT NULL ,  `time_to` DATETIME NOT NULL ,  `time_from` DATETIME NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="clinic_db" targettable="days_of_week">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `days_of_week` ADD INDEX(`schedule_id`);</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="clinic_db" targettable="patients">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `clinic_db`.`patients` ( `patient_id` INT NOT NULL AUTO_INCREMENT ,  `first_name` VARCHAR(255) NOT NULL ,  `last_name` VARCHAR(255) NOT NULL ,  `email` VARCHAR(255) NOT NULL ,  `phone` VARCHAR(10) NOT NULL ,  `date_of_birth` DATE NOT NULL ,  `gender` VARCHAR(10) NOT NULL ,  `username` VARCHAR(255) NOT NULL ,  `password` VARCHAR(255) NOT NULL ,    PRIMARY KEY  (`patient_id`),    UNIQUE  `UK_email` (`email`),    UNIQUE  `UK_phone` (`phone`),    UNIQUE  `UK_username` (`username`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="clinic_db" targettable="appoinments">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `clinic_db`.`appoinments` ( `appoinment_id` INT NOT NULL AUTO_INCREMENT ,  `patient_id` INT NOT NULL ,  `doctor_id` INT NOT NULL ,  `clinic_id` INT NOT NULL ,  `time_from` DATETIME NOT NULL ,  `time_to` DATETIME NOT NULL ,  `status` VARCHAR(255) NOT NULL ,    PRIMARY KEY  (`appoinment_id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="clinic_db" targettable="appoinments">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `appoinments` ADD INDEX(`patient_id`, `doctor_id`, `clinic_id`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="clinic_db" targettable="appoinments">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `appoinments`</span>
                        </div>
